...
*/
var pessoa = { nome: "Lucas", sobrenome: "Landim", sexo: "masculino", idade: 27, altura: 1.75, peso: 73, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Lucas Landim'
...
// Agora, apresente-se ;)
pessoa.apresentacao();
'Olá, eu sou o Lucas Landim, tenho 30 anos, 1.75m, meu peso é 73 e, só hoje, eu já caminhei 95 metros!'
```
